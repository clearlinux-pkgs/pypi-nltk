...
Source0  : https://files.pythonhosted.org/packages/3c/87/db8be88ad32c2d042420b6fd9ffd4a149f9a0d7f0e86b3f543be2eeeedd2/nltk-3.9.1.tar.gz
...
%prep
%setup -q -n nltk-3.9.1
cd %{_builddir}/nltk-3.9.1
pushd ..
cp -a nltk-3.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724079006
...
cp %{_builddir}/nltk-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-nltk/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
...
/usr/share/package-licenses/pypi-nltk/2b8b815229aa8a61e483fb4ba0588b8b6c491890
